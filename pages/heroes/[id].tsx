...
function HeroPage({ heroId }: { heroId: string }) {
  ...
  return (
    ...
    >
      {isLoadingHero && <Text fontSize="30px">Loading your suifren...</Text>}
      {!isLoadingHero && !hero && (
          ...
          <Flex height="100%" justifyContent="space-between">
            ...
            <VStack flex={1} align="center" justify="flex-end">
              ...
              <HStack mt="22px" gap="20px">
                ...
                >
                  <Button size="md" variant="outline">
                    <Box transform="skew(10deg)">Talk with your Suifren</Box>
                  </Button>
                </Link>
                {user && user.wallet === ownerAddress(hero.owner) && (
                  <>
...
export default function Page() {
  ...
  if (!heroId) return <Text fontSize="30px">Loading suifren id...</Text>;
